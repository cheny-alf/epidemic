...
public class MailUtil {
    ...
    public static String myEmailAccount = "1285682410@qq.com";
    public static String myEmailPassword = "kgwaneivsrdebafe";
    ...
    public static void main(String[] args) throws Exception {
        ...
        message.setRecipient(MimeMessage.RecipientType.TO,
                new InternetAddress("2489502883@qq.com", "语晴同学", "UTF-8"));

        message.setSubject("来自陈师傅的邮件", "UTF-8");
